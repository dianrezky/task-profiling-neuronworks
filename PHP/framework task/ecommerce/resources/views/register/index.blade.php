                    ...
                    <div class="register-form">
                        ...
                        <form action="/register" method="POST">
                            ...
                            <div class="group-input">
                                ...
                                <input type="text" id="name" placeholder="Enter Your Full Name" name="name" value="{{ old('name') }}" class="form-control rounded-top @error('name') is-invalid @enderror" required>
                                @error('name')
                            ...
                            <div class="group-input-address">
                                ...
                                <input type="text" id="address" name="address" placeholder="Enter Your Address" value="{{ old('address') }}" class="form-control rounded-top @error('address') is-invalid @enderror" required>
                                @error('address')
                                <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div>
                                ...
                                <label for="male">&ensp;Female</label>
                                @error('gender')
                                <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                    {{ $message }}
                                </div>
