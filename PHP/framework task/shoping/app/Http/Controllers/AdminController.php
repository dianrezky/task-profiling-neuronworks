...
class AdminController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect('/view')->with('success', 'Success To Add 1 Furniture');
    ...
    public function update(Request $request, $id){
        ...
        return redirect('/view')->with('success',' Data Has Been Updated!');
    }
    ...
    public function destroy($id){
        ...
        return redirect('/view')->with('success',' Data Has Been Deleted!');
    }
